...
import (
	...
	"github.com/r3dpixel/card-client/services/facade"
...
func (s *Service) ExportLatestCards(cardIDs ...scheme.CardID) (operation.ID, error) {
	...
	go func() {
		...
		if fileNameBuilder == nil {
			fileNameBuilder = facade.DefaultFileNameBuilder
		}
...
func (s *Service) exportLatestCard(ctx context.Context, fileNameBuilder facade.FileNameBuilder, cardID scheme.CardID, exportPath string, maxExportSize int) error {
