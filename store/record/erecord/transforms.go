...
func mapExportHeader(entity *ent.RecordEntity, header *resource.ExportHeader) {
	header.ID = entity.ID
	header.ExportTime = entity.ExportTime
	header.ExportedVersion = entity.ExportedVersion
}
