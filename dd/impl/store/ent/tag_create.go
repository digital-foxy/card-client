...
func (_c *TagCreate) SetID(v scheme.TagID) *TagCreate {
	_c.mutation.SetID(v)
	return _c
}

// AddCardIDs adds the "cards" edge to the Card entity by IDs.
func (_c *TagCreate) AddCardIDs(ids ...scheme.CardID) *TagCreate {
	_c.mutation.AddCardIDs(ids...)
	return _c
}

// AddCards adds the "cards" edges to the Card entity.
func (_c *TagCreate) AddCards(v ...*Card) *TagCreate {
...
func (_c *TagCreate) sqlSave(ctx context.Context) (*Tag, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(scheme.TagID); ok {
			_node.ID = id
		} else {
			return nil, fmt.Errorf("unexpected Tag.ResourceID type: %T", _spec.ID.Value)
		}
	}
...
//		// update values.
//		UpdateInfoSyncData(func(u *ent.TagUpsert) {
//			SetName(v+v).
//		}).
//		Exec(ctx)
...
func (u *TagUpsertOne) ID(ctx context.Context) (id scheme.TagID, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ResourceID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("ent: TagUpsertOne.ResourceID is not supported by MySQL driver. Use TagUpsertOne.Exec instead")
	}
...
func (u *TagUpsertOne) IDX(ctx context.Context) scheme.TagID {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
